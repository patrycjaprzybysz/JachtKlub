export default function LandingAbout() {
    return (
        <>
            <h2 className="mx-14 my-8 font-jaldi text-3xl text-text font-bold">O nas</h2>
            <div className="flex gap-10">
                ...
                <div className="w-1/2">
                    ...
                    <p className="w-8/9">
                        ...
                        parających się w życiu najprzeróżniejszymi aktywnościami. JKKMD posiada osobowość prawną. Pragniemy aby nasz Jacht Klubu przynosił
                        chlubę naszemu regionowi.
                    </p>
                </div>
            </div>
