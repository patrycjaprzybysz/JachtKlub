      ...
      {/* <Link to="/podstrona z galeria">  */}
        ...
        <div className="gallery__content | flow">
          <div className="gallery__content--container | flow">
            <h2 className="gallery__title" style={{ color: "white", fontSize: "20px", position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', textAlign: 'center', margin: '0', zIndex: '2' }}>
              {title}
            </h2>
          </div>
        </div>
